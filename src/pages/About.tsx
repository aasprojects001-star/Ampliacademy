...
const team = [
  { name: 'Ayotunde Aboderin', role: 'CEO & Founder', img: 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=300&q=80' },
  { name: 'Leadership Team', role: 'Coming Soon', img: null },
]
      ...
      <section className="relative pt-16 pb-24 px-6 overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto relative z-10 text-center">
          ...
          <p className="text-white/55 text-xl leading-relaxed max-w-2xl mx-auto">
            {isYSDI
              ? 'The Youth Sustainable Development Initiative is a Pan-African movement dedicated to empowering the next generation to drive meaningful change in their communities.'
              : 'AmpliYouth Advocacy Academy is a leadership and advocacy institution committed to identifying, grooming, and amplifying young changemakers, particularly from underserved and marginalized communities across Africa.'}
          </p>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-16 items-center">
          <div>
            ...
            <div className="space-y-5 text-white/55 leading-relaxed">
              <p>The Academy operates as both a training platform and a movement — supporting young people to develop the knowledge, skills, and confidence required to influence systems, shape public discourse, and lead community-driven solutions.</p>
              ...
              <p>AmpliYouth Advocacy Academy was created to bridge this gap — ensuring that talent, integrity, and purpose are not limited by geography or socioeconomic background.</p>
            </div>
          </div>

          <div className="relative">
            <div className="glass rounded-3xl overflow-hidden">
              <img src="https://images.unsplash.com/photo-1552664730-d307ca884978?w=700&q=80" alt="Leadership discussion" className="w-full h-96 object-cover opacity-90" />
            </div>
        ...
        <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-6">
          <div className={`glass-primary p-10 rounded-3xl border ${accentBorder}`}>
            ...
            <p className="text-white/55 leading-relaxed">
              To educate, empower, and amplify socially conscious young people by providing leadership training, advocacy skills, mentorship, networks, and access to platforms that enable them to drive justice, equity, and sustainable development.
            </p>
          </div>
          <div className="glass p-10 rounded-3xl">
            ...
            <p className="text-white/55 leading-relaxed">
              A generation of principled, resilient, and creative youth leaders shaping policies, narratives, and communities at local, national, and global levels — a continent where no young person is held back by circumstance.
            </p>
          </div>
        </div>
      </section>
            ...
            {values.map(({ icon: Icon, title, desc }) => (
              <div key={title} className="glass-hover p-7">
                <div className={`w-12 h-12 rounded-xl flex items-center justify-center mb-5 ${isYSDI ? 'bg-ysdi/20' : 'bg-primary/20'}`}>
                  <Icon size={22} className={isYSDI ? 'text-ysdi-light' : 'text-primary-400'} />
                </div>
      ...
      <section className="section">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className={`glass rounded-3xl p-10 border ${accentBorder}`}>
            <div className="w-24 h-24 rounded-2xl mx-auto mb-6 overflow-hidden bg-gradient-to-br from-primary to-primary-700 flex items-center justify-center text-3xl font-bold">
              AA
            </div>
            ...
            <p className="text-white/55 leading-relaxed max-w-2xl mx-auto">
              A youth advocate and social impact leader committed to expanding access to leadership development and advocacy platforms for young people across Africa. Ayotunde founded AmpliYouth from a deep personal conviction that the next generation of African leaders exists in every community — they just need the right platform to rise.
            </p>
          </div>
        </div>
      </section>
